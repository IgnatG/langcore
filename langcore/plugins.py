...
_BUILTINS: dict[str, str] = {
    "gemini": "langcore.providers.gemini:GeminiLanguageModel",
    "ollama": "langcore.providers.ollama:OllamaLanguageModel",
}

# Optional built-in providers (require extra dependencies)
_OPTIONAL_BUILTINS: dict[str, str] = {
    "openai": "langcore.providers.openai:OpenAILanguageModel",
}
...
def _discovered() -> dict[str, str]:
    ...
    for ep in _safe_entry_points("langcore.providers"):
