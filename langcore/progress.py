"""Progress and visualization utilities for LangCore."""
...
def create_download_progress_bar(
    ...
    return tqdm.tqdm(
        ...
        unit="B",
        unit_scale=True,
        desc=(f"{BLUE}{BOLD}LangCore{RESET}: Downloading {GREEN}{url_display}{RESET}"),
        bar_format=(
...
def format_extraction_progress(
    ...
    # Base description
    if model_info:
        desc = f"{BLUE}{BOLD}LangCore{RESET}: model={GREEN}{model_info}{RESET}"
    else:
        desc = f"{BLUE}{BOLD}LangCore{RESET}: Processing"
