...
from langcore import data_lib, progress
from langcore.core import data, exceptions

DEFAULT_TIMEOUT_SECONDS = 30


class InvalidDatasetError(exceptions.LangCoreError):
...
def download_text_from_url(
    ...
    try:
        ...
        raise requests.RequestException(f"Failed to download from {url}: {e!s}") from e
