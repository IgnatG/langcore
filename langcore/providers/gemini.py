...
from langcore.providers import gemini_batch, patterns, router, schemas
    ...
    def _process_single_prompt(
        ...
        try:
            ...
            raise exceptions.InferenceRuntimeError(
                f"Gemini API error: {e!s}", original=e
            ) from e
