...
```
1. pip install langcore-yourprovider
...
from langcore.providers.gemini import GeminiLanguageModel
...
└── langcore_yourprovider/   # Package directory
...
myprovider = "langcore_myprovider:MyProviderLanguageModel"
...
Now users can install and use your provider with just `pip install langcore-myprovider`!
...
```python
# langcore_myprovider/provider.py
class MyProviderLanguageModel(lx.inference.BaseLanguageModel):
