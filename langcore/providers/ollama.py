"""Ollama provider for LangCore.

This provider enables using local Ollama models with LangCore's extract() function.
...
Direct provider instantiation (when model ID conflicts with other providers):
    from langcore.providers.ollama import OllamaLanguageModel
...
Using pre-configured FormatHandler for manual control:
    from langcore.providers.ollama import OLLAMA_FORMAT_HANDLER
