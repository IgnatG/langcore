...
from langcore import prompting
from langcore.core import base_model, data, schema, types
...
class InitTest(parameterized.TestCase):
    ...
    @mock.patch("langcore.extraction.resolver.Resolver.align")
    @mock.patch("langcore.extraction.factory.create_model")
    ...
    @mock.patch("langcore.annotation.Annotator.annotate_text")
    @mock.patch("langcore.extraction.factory.create_model")
    ...
    @mock.patch("langcore.extraction.resolver.Resolver")
    @mock.patch("langcore.extraction.factory.create_model")
    def test_extract_resolver_params_none_handling(
        ...
        with mock.patch("langcore.annotation.Annotator.annotate_text") as mock_annotate:
            mock_annotate.return_value = lx.data.AnnotatedDocument(
                text="test", extractions=[]
            )
    ...
    @mock.patch("langcore.annotation.Annotator.annotate_documents")
    @mock.patch("langcore.extraction.factory.create_model")
    ...
    @mock.patch("langcore.progress.create_extraction_progress_bar")
    @mock.patch("langcore.extraction.factory.create_model")
    ...
    @mock.patch("langcore.factory.create_model")
    ...
    def test_gemini_schema_deprecation_warning(self):
        ...
        self.enter_context(
            mock.patch(
                "langcore.annotation.Annotator.annotate_text",
