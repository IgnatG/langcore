...
class ExtractSchemaIntegrationTest(absltest.TestCase):
    ...
    def test_extract_with_gemini_uses_schema(self):
        ...
        with (
            mock.patch(
                "langcore.providers.gemini.GeminiLanguageModel.__init__",
                return_value=None,
            ) as mock_init,
            mock.patch(
                "langcore.providers.gemini.GeminiLanguageModel.infer",
    ...
    def test_extract_with_ollama_uses_json_mode(self):
        ...
        with (
            mock.patch(
                "langcore.providers.ollama.OllamaLanguageModel.__init__",
                return_value=None,
            ) as mock_init,
            mock.patch(
                "langcore.providers.ollama.OllamaLanguageModel.infer",
                return_value=iter([[mock.Mock(output='{"extractions": []}')]]),
            ),
            mock.patch(
                "langcore.annotation.Annotator.annotate_text",
    ...
    def test_extract_explicit_fence_respected(self):
        ...
        with (
            ...
            mock.patch(
                "langcore.annotation.Annotator.__init__", return_value=None
    ...
    def test_extract_no_schema_when_disabled(self):
        ...
        with (
            mock.patch(
                "langcore.providers.gemini.GeminiLanguageModel",
