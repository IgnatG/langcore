...
These tests cover the core changes in ``langcore/annotation.py``:
...
from langcore.annotation import _merge_non_overlapping_extractions
from langcore.core.data import CharInterval, Extraction
