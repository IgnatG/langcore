...
from langcore.core import tokenizer
...
class UnicodeTokenizerTest(parameterized.TestCase):
    ...
    def test_script_boundary_grouping(self):
        ...
        t1_text = text[
            tokenized.tokens[0].char_interval.start_pos : tokenized.tokens[
                0
            ].char_interval.end_pos
        ]
        t2_text = text[
            tokenized.tokens[1].char_interval.start_pos : tokenized.tokens[
                1
            ].char_interval.end_pos
        ]
